...
import static io.strimzi.testsuite.oauth.support.KafkaClientConfig.buildConsumerConfigOAuthBearer;
import static io.strimzi.testsuite.oauth.support.KafkaClientConfig.buildProducerConfigOAuthBearer;
import static io.strimzi.testsuite.oauth.support.KafkaClientConfig.loginWithUsernameForRefreshToken;
import static io.strimzi.testsuite.oauth.support.KafkaClientConfig.loginWithUsernamePassword;
import static io.strimzi.testsuite.oauth.support.KafkaClientConfig.poll;
...
public class BasicIT {
    ...
    void oauthMetricsConfigIntegration() {
        ...
        line = lines.get(3);
        Assertions.assertTrue(line.contains("io.strimzi.testsuite.oauth.common.metrics.TestMetricsReporter"), "io.strimzi.testsuite.oauth.common.metrics.TestMetricsReporter");
