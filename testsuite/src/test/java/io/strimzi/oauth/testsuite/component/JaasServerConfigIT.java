...
public class JaasServerConfigIT {
    ...
    void testJwksValidatorOptions() throws IOException {
        ...
        attrs.put(GlobalConfig.STRIMZI_OAUTH_METRIC_REPORTERS, TestMetricsReporter.class.getName());
        ...
        try {
            ...
            Assertions.assertTrue(exception.getMessage()
                .contains("'oauth.client.id' must be set when 'oauth.check.audience' is 'true'"), "Error message check");
        }
        ...
        try {
            ...
            Assertions.assertTrue(exception.getMessage()
                .contains("Can't use both clientId and bearerToken"), "Error message check");
        }
