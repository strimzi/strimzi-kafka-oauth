...
public class JwtManipulationIT {
    ...
    private JsonNode getActiveKeyInfo(String accessToken, String realm) throws IOException {
        return HttpUtil.get(URI.create("http://" + env.getKeycloakHostPort() + "/admin/realms/" + realm + "/keys"), "Bearer " + accessToken, JsonNode.class);
    }
    ...
    private String getOriginalToken() throws IOException {
        ...
        final String tokenEndpointUri = "http://" + env.getKeycloakHostPort() + "/realms/" + realm + "/protocol/openid-connect/token";
