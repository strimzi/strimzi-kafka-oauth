...
public class HydraTestEnvironment {
    ...
    public void start() {
        ...
        hydra = new FixedHostPortGenericContainer<>("oryd/hydra:v2.3.0")
                ...
                .withCopyToContainer(
                        MountableFile.forHostPath(Path.of("../docker/target/hydra/certs").toAbsolutePath().toString()),
                        "/tmp/certs")
        ...
        hydraImport = new GenericContainer<>("testsuite/hydra-import:latest")
                ...
                .withCopyToContainer(
                        ...
                        "/hydra")
                .withCopyToContainer(
                        MountableFile.forHostPath(Path.of("../docker/target/hydra-import/certs").toAbsolutePath().toString()),
                        "/hydra/certs")
