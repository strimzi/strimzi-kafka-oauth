...
public class RefreshTest extends BasicTest {
    ...
    private void changePermissionsForClients() throws IOException {
        ...
        String token = loginWithUsernamePassword(URI.create("http://keycloak:8080/realms/master/protocol/openid-connect/token"),
        ...
        String clientsUrl = "http://keycloak:8080/admin/realms/kafka-authz/clients";
        ...
        //
        //  GET http://localhost:8080/admin/realms/kafka-authz/clients/f71ed8e3-8a4a-47f0-b2b5-0971bd93cea8/authz/resource-server/resource?deep=false&first=0&max=20
        //
        ...
        //
        //  GET http://localhost:8080/admin/realms/kafka-authz/clients/f71ed8e3-8a4a-47f0-b2b5-0971bd93cea8/authz/resource-server/scope?deep=false&first=0&max=20
        //
        ...
        //
        //  GET http://localhost:8080/admin/realms/kafka-authz/clients/f71ed8e3-8a4a-47f0-b2b5-0971bd93cea8/authz/resource-server/policy?first=0&max=20&permission=false
        //
    ...
    private void removePermissions(String authorization, String clientId, String devTeamAPermission, String devTeamBPermission) throws IOException {
        String permissionUrl = "http://keycloak:8080/admin/realms/kafka-authz/clients/" + clientId + "/authz/resource-server/permission/" + devTeamAPermission;
        HttpUtil.delete(URI.create(permissionUrl), authorization);

        permissionUrl = "http://keycloak:8080/admin/realms/kafka-authz/clients/" + clientId + "/authz/resource-server/permission/" + devTeamBPermission;
        HttpUtil.delete(URI.create(permissionUrl), authorization);
    }
    ...
    private void addPermissions(String authorization, String clientId, String describeScope, String writeScope, String aTopicsId, String bTopicsId, String devTeamA, String devTeamB) throws IOException {
        ...
        //  Create a new scope permission using the cluster-name:my-cluster,Topic:b_* resource id, 'Describe' and 'Write' scope ids, and 'Dev Team A' policy id
        //
        //  POST http://localhost:8080/admin/realms/kafka-authz/clients/f71ed8e3-8a4a-47f0-b2b5-0971bd93cea8/authz/resource-server/permission/scope
        //
        ...
        String permissionUrl = "http://keycloak:8080/admin/realms/kafka-authz/clients/" + clientId + "/authz/resource-server/permission/scope";
    ...
    private Map<String, String> getAuthzScopes(String authorization, String clientId) throws IOException {
        String scopesUrl = "http://keycloak:8080/admin/realms/kafka-authz/clients/" + clientId + "/authz/resource-server/scope";
    ...
    private Map<String, String> getAuthzResources(String authorization, String clientId) throws IOException {
        String resourcesUrl = "http://keycloak:8080/admin/realms/kafka-authz/clients/" + clientId + "/authz/resource-server/resource";
    ...
    private Map<String, String> getAuthzPolicies(String authorization, String clientId) throws IOException {
        String policiesUrl = "http://keycloak:8080/admin/realms/kafka-authz/clients/" + clientId + "/authz/resource-server/policy";
