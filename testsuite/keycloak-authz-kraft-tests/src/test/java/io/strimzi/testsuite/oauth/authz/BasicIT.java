...
public class BasicIT extends Common {
    ...
    @Test
    @Order(1)
    @DisplayName("Test Team A client - Part 1")
    @Tag("authorization")
    @Tag("team-a")
    public void testTeamAClientPart1() throws Exception {
    ...
    @Test
    @Order(2)
    @DisplayName("Test Team B client - Part 1")
    @Tag("authorization")
    @Tag("team-b")
    public void testTeamBClientPart1() throws Exception {
    ...
    @Test
    @Order(3)
    @DisplayName("Create topic as cluster manager")
    @Tag("authorization")
    @Tag("admin")
    public void createTopicAsClusterManager() throws Exception {
    ...
    @Test
    @Order(4)
    @DisplayName("Test Team A client - Part 2")
    @Tag("authorization")
    @Tag("team-a")
    public void testTeamAClientPart2() throws Exception {
    ...
    @Test
    @Order(5)
    @DisplayName("Test Team B client - Part 2")
    @Tag("authorization")
    @Tag("team-b")
    public void testTeamBClientPart2() throws Exception {
        //
    ...
    @Test
    @Order(6)
    @DisplayName("Test cluster manager permissions")
    @Tag("authorization")
    @Tag("admin")
    ...
    @Test
    @Order(7)
    @DisplayName("Test user with no permissions")
    @Tag("authorization")
    @Tag("denied")
    public void testUserWithNoPermissions() throws Exception {
        //
