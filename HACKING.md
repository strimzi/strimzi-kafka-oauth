...
We have to update the oauth library dependency version:
    ...
    sed -Ei 's#<strimzi-oauth.version>[0-9a-zA-Z.-]+</strimzi-oauth.version>#<strimzi-oauth.version>0.16.0</strimzi-oauth.version>#g' \
      pom.xml \
...
The deployed version should be 0.16.0.
