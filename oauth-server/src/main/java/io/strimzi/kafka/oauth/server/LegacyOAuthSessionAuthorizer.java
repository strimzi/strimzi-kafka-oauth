...
/**
 * Note: This class has been deprecated. Use functionally equivalent <tt>io.strimzi.kafka.oauth.server.OAuthSessionAuthorizer</tt> class.
 * <p>
 ...
 * <pre>
 *     authorizer.class.name=io.strimzi.kafka.oauth.server.LegacyOAuthSessionAuthorizer
 ...
 * </pre>
 * With this setting the LegacyOAuthSessionAuthorizer behaves as if there was no authorizer installed - it grants everything with
...
public class LegacyOAuthSessionAuthorizer implements kafka.security.auth.Authorizer {

    static final Logger log = LoggerFactory.getLogger(LegacyOAuthSessionAuthorizer.class);
    static final Logger GRANT_LOG = LoggerFactory.getLogger(LegacyOAuthSessionAuthorizer.class.getName() + ".grant");
    static final Logger DENY_LOG = LoggerFactory.getLogger(LegacyOAuthSessionAuthorizer.class.getName() + ".deny");
    ...
    public void configure(java.util.Map<String, ?> configs) {
        ...
        if (log.isDebugEnabled()) {
            log.debug("Configured LegacyOAuthSessionAuthorizer:"
